...
class UploadBirthdayPage extends Component {
    constructor(props) {
        super(props);
...
UploadBirthdayPage = withRoot(withStyles(styles)(UploadBirthdayPage));
export default withAuthorization(authCondition)(UploadBirthdayPage);
