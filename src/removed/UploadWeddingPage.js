...
class UploadWeddingPage extends Component {
    constructor(props) {
        super(props);
    ...
    filesUpload = (files) => {
        var imagesRef = storage.getWeddingImages();//storage
        var uploadImagesRef = db.getWeddingImages();//db
...
UploadWeddingPage = withRoot(withStyles(styles)(UploadWeddingPage));
export default withAuthorization(authCondition)(UploadWeddingPage);
