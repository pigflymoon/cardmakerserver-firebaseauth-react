...
class UploadOthersPage extends Component {
    constructor(props) {
        super(props);
    ...
    filesUpload = (files) => {
        var imagesRef = storage.getOtherImages();//storage
        var uploadImagesRef = db.getOtherImages();//db
...
UploadOthersPage = withRoot(withStyles(styles)(UploadOthersPage));
export default withAuthorization(authCondition)(UploadOthersPage);
